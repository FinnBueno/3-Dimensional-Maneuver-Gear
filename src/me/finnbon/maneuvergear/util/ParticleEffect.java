...
import me.finnbon.maneuvergear.util.ReflectionHandler.PackageType;
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				playerConnection = ReflectionHandler.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false,
						"playerConnection");
				sendPacket = ReflectionHandler.getMethod(playerConnection.getType(), "sendPacket",
